...
- **工具版本**: git tag,当前 **v2.4.0** —— 抽取器 / CLI 行为。
- **交接包模板版本**: 当前 **v1.11** —— 包内的段落结构。各字段带 `[v1.x]` 标记表示
  引入它的模板版本(如 repo anchors 的 verify 行是 v1.11;runtime surfaces 和 confidence 是 v1.10)。
